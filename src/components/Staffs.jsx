            ...
            <div className="splitDiv">
              <div className="leftDiv">
                <div className="info-row">
                    ...
                    <p className="info-value">{selectedUser.first_name}</p>
                </div>
                <div className="info-row">
                    <p className="info-label">Last Name:</p>
                    <p className="info-value">{selectedUser.last_name}</p>
                </div>
                <div className="info-row">
                ...
                <div className="info-row">
                    ...
                    <p className="info-value">{selectedUser.department}</p>
                </div>
                <div className="info-row">
                ...
                <div className="info-row">
                    ...
                    <p className="info-value">{selectedUser.job_type}</p>
                </div>
              </div>
              ...
              <div className="rightDiv">
                <div className="info-row">
                    ...
                    <p className="info-value">{selectedUser.phone_no}</p>
                </div>
                <div className="info-row">
                    <p className="info-label">Date of Birth:</p>
                    <p className="info-value">{selectedUser.date_of_birth?.substring(0,10)}</p>
                </div>
                <div className="info-row">
                ...
                <div className="info-row">
                    ...
                    <p className="info-value">{selectedUser.postal_code}</p>
                </div>
              </div>
            </div>
